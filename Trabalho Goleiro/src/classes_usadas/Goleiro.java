...
public class Goleiro 
{
	...
	private int PontuaçãoMaxima = 0;
	private int GolsMaisTomados[] = {0, 0, 0, 0};
	...
	{
		return PontuaçãoMaxima;
	}
	public void AumentarPontuaçãoMaxima()
	{
		PontuaçãoMaxima++;
	}
	
	public int[] getGolsMaisTomados()
	{
		return GolsMaisTomados;
	}
}
